...
document.write('<tr style="background:#939593;font:12px Arial;color:#FFFFFF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
...
document.write('<tr><td class="current-day button" colspan="7" align="center" style="cursor:pointer;font:13px Arial" onclick="today()">Сегодня: '+addnull(sccd,sccm+1,sccy)+  ' </td></tr>');
document.write('<tr><td colspan="7"  class="button" align="center" style="cursor:pointer;font:13px Arial" onclick="cl()">Омена  </td></tr>');
document.write('</table>');

document.all?document.attachEvent('onclick',checkClick):document.addEventListener('click',checkClick,false);


//<img src="images_monitoring/klcl.jpg" alt="альтернативный текст">
